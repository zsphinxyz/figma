  ...
  return (
    <section className='w-auto pt-20 pb-10 lg:py-12 mx-auto cursor-default'>
      <div className="flex flex-col justify-center mx-auto sm:w-[580px] lg:w-[1000px] items-center gap-5 lg:gap-10 relative">
          ...
          <p className=" text-SecColor bg-stone-700 px-5 py-1 w-fit rounded-full text-xl cursor-pointer hover:text-PrimColor">Introduction Raft Cards {'▶'} </p>
          ...
          <h2 className="text-SecColor text-md sm:text-xl text-center max-w-[700px] mx-auto px-10 md:px-0">Experience the future of banking with RAFT. We're here to empower your financial journey.</h2>
